...
class Mentee(object):
    ...
    def __init__(self, firstName, lastName, year, email, qualifications, courses, mentors, areas):
        """
    ...
    def __eq__(self, otherMentee):
         ...
         """
         return (self.firstName == otherMentee.firstName) and (self.lastName == otherMentee.lastName)